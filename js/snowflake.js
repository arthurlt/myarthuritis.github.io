...
Snowflakes = (function () {
    ...
    var snowflakes = [];
    var snowflakesDefaultCount = 100;
    ...
    function advanceSnowFlakes() {
        for (var ii = 0; ii < snowflakes.length; ii++) {
            ...
            // we obey the gravity, 'cause it// single animation loop and fps calculation's the law
...
(function () {
    ...
    var snowflakesCanvas = document.getElementById("themecanvas");
    var snowflakesContext = document.getElementById("themecanvas").getContext("2d");
